...
public class SQLStatement {
    ...
    public static final String GET_USER = "SELECT `status`, `id`, `luong`, `last_attendance_at`, `received_first_gift`, `password`, `ip_address`, `level_reward`, `Is_Admin_WEB`, `kh`, `efffan`,`tester`,`timelogin`, `effvip`, `efftop`, `effytb`, `effdg`, `effygt`, `effydc`, `nhanmocnap`, `effydh`, `online`, `ban_until`, `activated` FROM `users` WHERE `username` = ?;";
    ...
    public static final String GET_XSMB_ORDER = "SELECT id, name, qty, number FROM `XSMB_ORDER` WHERE `name` = ? AND (`server` = ? OR `server` = 0) AND DATE(trading_date)=STR_TO_DATE(?,'dd/MM/YYYY');";
    ...
    public static final String GET_XSMB = "SELECT ket_qua from xsmb";
