...
public class ItemManager {
    ...
    public static final int[] VT_OPTION_ID = new int[]{   6,    7,  10,  67,  68,  69,  70, 71, 72, 73, 74};
    public static final int[] VT_OPTION_PARAM = new int[]{200, 200, 50, 5,   60, 10,  10, 10, 10, 1000, 50};
