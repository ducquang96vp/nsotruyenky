...
public class SelectCardVIP extends AbsSelectCard {
    ...
    protected void init() {
        ...
        add(Card.builder().id(ItemName.PET_DAI_THANH).rate(0.75).build());
        add(Card.builder().id(ItemName.PET_BONG_MA).rate(0.75).build());
        ...
        add(Card.builder().id(ItemName.TRUNG_VI_THU).rate(2).build());
        add(Card.builder().id(ItemName.HAKAIRO_YOROI).rate(0.01).build());
        add(Card.builder().id(ItemName.NHAN_THUAN_THAN).rate(0.75).build());
