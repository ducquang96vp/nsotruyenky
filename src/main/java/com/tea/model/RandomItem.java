...
public class RandomItem {
    ...
    public static void init() {
        ...
        BOSS_LANG_TRUYEN_THUYET.add(1, ItemName.KHAI_THU_LENH);
        BOSS_LANG_TRUYEN_THUYET.add(10, ItemName.BAT_BAO);
        BOSS_LANG_TRUYEN_THUYET.add(0.1, ItemName.RUONG_HUYEN_BI);
        BOSS_LANG_TRUYEN_THUYET.add(0.5, ItemName.RUONG_BACH_NGAN);
        BOSS_LANG_TRUYEN_THUYET.add(0.01, ItemName.HARLEY_DAVIDSON);
        ...
        BOSS_LANG_TRUYEN_THUYET.add(0.01, ItemName.HOA_KY_LAN);
...
//        BOSS_LANG_TRUYEN_THUYET.add(0.1, 1271);
        ...
        // Làng truyền thuyết
        LANG_TRUYEN_THUYET.add(0.5, ItemName.HARLEY_DAVIDSON);
        LANG_TRUYEN_THUYET.add(0.5, ItemName.KHAI_THU_LENH);       
        ...
        LANG_TRUYEN_THUYET.add(0.08, ItemName.CHUYEN_TINH_THACH);
        ...
        LANG_TRUYEN_THUYET.add(0.1, ItemName.GIAY_PHEP_NANG_CAP);
        ...
        LANG_CO.add(2, ItemName.CHUYEN_TINH_THACH);
        LANG_CO.add(1, ItemName.TU_TINH_THACH_SO_CAP);
        LANG_CO.add(0.5, ItemName.TU_TINH_THACH_TRUNG_CAP);
        ...
        LANG_CO.add(0.5, ItemName.PHAN_THAN_LENH);
        ...
        BOSS_LANG_CO.add(10, ItemName.BAT_BAO);
        BOSS_LANG_CO.add(2, ItemName.ST);
        BOSS_LANG_CO.add(2, ItemName.PN);
        BOSS_LANG_CO.add(2, ItemName.SM);
        BOSS_LANG_CO.add(3, ItemName.PHAN_THAN_LENH);
        BOSS_LANG_CO.add(3, ItemName.TU_TINH_THACH_TRUNG_CAP);
        BOSS_LANG_CO.add(1, ItemName.TU_TINH_THACH_CAO_CAP);
        BOSS_LANG_CO.add(5, ItemName.CHUYEN_TINH_THACH);
        ...
        BOSS_LANG_CO.add(0.5, ItemName.DA_CAP_12);
        BOSS_LANG_CO.add(0.01, ItemName.KHAI_THU_LENH);       
        ...
        BOSS_LANG_CO.add(0.05, ItemName.HARLEY_DAVIDSON);
        BOSS_LANG_CO.add(0.01, ItemName.HUYET_SAC_HUNG_LANG);
        ...
        BOSS_LANG_CO.add(0.05, ItemName.HOA_KY_LAN);
        BOSS_LANG_CO.add(5, ItemName.t1);
        BOSS_LANG_CO.add(4, ItemName.t2);
        
        //map úp yên 
        UPYEN.add(80, ItemName.YEN);
        //map úp luong 
        UPluong.add(10, 1290);
        UPluong.add(10, 1291);
        UPluong.add(10, 1292);
        ...
        ITEM.add(0.01, ItemName.BAO_HIEM_SO_CAP);
        ...
        vt.add(5, ItemName.CHUYEN_TINH_THACH);
        ...
        BOSS_EVENT.add(5, ItemName.XICH_NHAN_NGAN_LANG);
        BOSS_EVENT.add(10, ItemName.HAGGIS);
        BOSS_EVENT.add(20, ItemName.PHIEU_MAY_MAN);
        BOSS_EVENT.add(0.5, ItemName.RUONG_HAC_AM);
        BOSS_EVENT.add(0.5, ItemName.KHOA_HAC_AM);
        BOSS_EVENT.add(1, ItemName.SACH_VO_CONG_ENKO_BAKUSATSU);
        BOSS_EVENT.add(1, ItemName.SACH_VO_CONG_TSUMABENI);       
        BOSS_EVENT.add(1, ItemName.SACH_VO_CONG_SHABONDAMA); 
        BOSS_EVENT.add(1, ItemName.SACH_VO_CONG_KOGORASERU);
        BOSS_EVENT.add(1, ItemName.SACH_VO_CONG_RAIJIN);
        BOSS_EVENT.add(1, ItemName.SACH_VO_CONG_KAMIKAZE);
        BOSS_EVENT.add(1.5, ItemName.LUC_THANH_HOA);
        BOSS_EVENT.add(1.5, ItemName.TU_LINH_LIEN_HOA);
        BOSS_EVENT.add(1.5, ItemName.LINH_LANG_HO_DIEP);
        ...
        BOSS.add(3, ItemName.DA_CAP_10);
        BOSS.add(3, ItemName.DA_CAP_11);
        BOSS.add(20, ItemName.PHIEU_MAY_MAN);
        BOSS.add(20, ItemName.PHAN_THAN_LENH);
        BOSS.add(2, ItemName.RUONG_HAC_AM);
        BOSS.add(1, ItemName.ST);  //đá khai hóa
        BOSS.add(1, ItemName.PN);
        BOSS.add(1, ItemName.SM);
        BOSS.add(5, ItemName.BAT_BAO);
        BOSS.add(0.5, ItemName.RUONG_BACH_NGAN);
        BOSS.add(100,1294);
        BOSS.add(0.09, ItemName.RUONG_HUYEN_BI);
       ...
       // Vùng đất ma quỷ --- đang nhân 10 mỗi item trừ đá 5
        ...
        VDMQ.add(0.9, ItemName.DONG_CO_V_POWER);
        VDMQ.add(1, ItemName.THI_LUYEN_THIEP);
        VDMQ.add(1, ItemName.DINH_VI);
        VDMQ.add(0.7, ItemName.BINH_NITRO);
        ...
        VDMQ.add(0.4, ItemName.LINH_LANG_HO_DIEP);
        VDMQ.add(0.05, ItemName.SACH_VO_CONG_KAGE_BUNSHIN);
        ...
        BOSS_VDMQ.add(100,1294);
        BOSS_VDMQ.add(100, ItemName.DA_CAP_8);
        BOSS_VDMQ.add(100, ItemName.DA_CAP_9);
        BOSS_VDMQ.add(70, ItemName.DA_CAP_10);
        BOSS_VDMQ.add(100, ItemName.BAT_BAO);
        BOSS_VDMQ.add(0.1, ItemName.RUONG_HUYEN_BI);
        BOSS_VDMQ.add(0.5, ItemName.RUONG_BACH_NGAN);
        BOSS_VDMQ.add(100, ItemName.PHAN_THAN_LENH);
        BOSS_VDMQ.add(0.2, ItemName.RUONG_HAC_AM);
        BOSS_VDMQ.add(11, ItemName.ST);
        BOSS_VDMQ.add(11, ItemName.PN);
        BOSS_VDMQ.add(11, ItemName.SM);
        BOSS_VDMQ.add(5, ItemName.DA_DANH_VONG_CAP_1);
        BOSS_VDMQ.add(4, ItemName.DA_DANH_VONG_CAP_2);
        BOSS_VDMQ.add(4, ItemName.DA_DANH_VONG_CAP_3);
        ...
        BOSS_VDMQ.add(1, ItemName.SACH_VO_CONG_ENKO_BAKUSATSU);
        BOSS_VDMQ.add(1, ItemName.SACH_VO_CONG_TSUMABENI);
        BOSS_VDMQ.add(1, ItemName.SACH_VO_CONG_KAMIKAZE);
        BOSS_VDMQ.add(3, ItemName.SACH_VO_CONG_KAGE_BUNSHIN);
        ...
        KHI_BAO.add(0.5, ItemName.HUYET_SAC_HUNG_LANG);
        ...
        LANG_BAO.add(0.5, ItemName.HUYET_SAC_HUNG_LANG);
        ...
        BANH_KHUC_CAY_CHOCOLATE.add(0.02, ItemName.RUONG_HUYEN_BI);
        BANH_KHUC_CAY_CHOCOLATE.add(0.08, ItemName.RUONG_BACH_NGAN);
        BANH_KHUC_CAY_CHOCOLATE.add(0.5, ItemName.BAT_BAO);
        ...
        BANH_KHUC_CAY_CHOCOLATE.add(30, ItemName.THE_BAI_KINH_NGHIEM_GIA_TOC_TRUNG);
        BANH_KHUC_CAY_CHOCOLATE.add(60, ItemName.DA_CAP_9);
        BANH_KHUC_CAY_CHOCOLATE.add(10, ItemName.DA_CAP_10);
        BANH_KHUC_CAY_CHOCOLATE.add(30, ItemName.MINH_MAN_DAN);
        BANH_KHUC_CAY_CHOCOLATE.add(30, ItemName.LONG_LUC_DAN);
        BANH_KHUC_CAY_CHOCOLATE.add(30, ItemName.KHANG_THE_DAN);
        BANH_KHUC_CAY_CHOCOLATE.add(30, ItemName.SINH_MENH_DAN);
        ...
        BANH_KHUC_CAY_DAU_TAY.add(0.1, ItemName.RUONG_BACH_NGAN);
        BANH_KHUC_CAY_DAU_TAY.add(0.5, ItemName.BAT_BAO);
        ...
        BANH_KHUC_CAY_DAU_TAY.add(20, ItemName.DA_CAP_10);
        BANH_KHUC_CAY_DAU_TAY.add(40, ItemName.MINH_MAN_DAN);
        BANH_KHUC_CAY_DAU_TAY.add(40, ItemName.LONG_LUC_DAN);
        BANH_KHUC_CAY_DAU_TAY.add(40, ItemName.KHANG_THE_DAN);
        BANH_KHUC_CAY_DAU_TAY.add(40, ItemName.SINH_MENH_DAN);
        ...
        VUA_TUAN_LOC.add(100, ItemName.MINH_MAN_DAN);
        VUA_TUAN_LOC.add(100, ItemName.LONG_LUC_DAN);
        VUA_TUAN_LOC.add(100, ItemName.KHANG_THE_DAN);
        VUA_TUAN_LOC.add(100, ItemName.SINH_MENH_DAN);
        ...
        VUA_TUAN_LOC.add(2, ItemName.DA_DANH_VONG_CAP_4);
        VUA_TUAN_LOC.add(1, ItemName.DA_DANH_VONG_CAP_5);

        // Đổi điểm người tuyết xu
        DOI_DIEM_NGUOI_TUYET_XU.add(0.5, ItemName.BAT_BAO);
        ...
        DOI_DIEM_NGUOI_TUYET_LUONG.add(0.5, ItemName.BAT_BAO);
        DOI_DIEM_NGUOI_TUYET_LUONG.add(0.1, ItemName.RUONG_BACH_NGAN);
        ...
        RUONG_CHIEN_TRUONG.add(20, ItemName.DA_CAP_11);
        RUONG_CHIEN_TRUONG.add(10, ItemName.DA_CAP_12);
        RUONG_CHIEN_TRUONG.add(10, ItemName.BAT_BAO);
        RUONG_CHIEN_TRUONG.add(0.5, ItemName.RUONG_BACH_NGAN);
        RUONG_CHIEN_TRUONG.add(0.5, ItemName.HARLEY_DAVIDSON);

        RUONG_HAC_AM.add(50, ItemName.DA_CAP_9);
        RUONG_HAC_AM.add(40, ItemName.DA_CAP_10);
        RUONG_HAC_AM.add(5, ItemName.DA_CAP_11);
        RUONG_HAC_AM.add(15, ItemName.GIAY_VANG);
        RUONG_HAC_AM.add(10, ItemName.GIAY_BAC);
        RUONG_HAC_AM.add(5, ItemName.BAT_BAO);
        RUONG_HAC_AM.add(0.5, ItemName.RUONG_BACH_NGAN);
        ...
        BUA_MAY_MAN.add(2, ItemName.DA_DANH_VONG_CAP_5);
        ...
        TRE_VANG_TRAM_DOT.add(20, ItemName.THE_BAI_KINH_NGHIEM_GIA_TOC_TRUNG);
        ...
        BOSS_LDGT.add(5, ItemName.MAT_NA_HO);
        BOSS_LDGT.add(5, ItemName.MAT_NA_SUPER_BROLY);
        BOSS_LDGT.add(5, ItemName.MAT_NA_ONNA_BUGEISHA);
        BOSS_LDGT.add(0.8, ItemName.PET_BONG_MA);
        BOSS_LDGT.add(0.8, ItemName.PET_YEU_TINH);
        BOSS_LDGT.add(0.5, ItemName.HAKAIRO_YOROI);
        // truong linh hon
        ...
        THAT_THU_BAO.add(3, ItemName.BAT_BAO);
        ...
        LONG_DEN.add(1, ItemName.MANH_SACH_CO);
        LONG_DEN.add(5, ItemName.VIEN_LINH_HON_CAP_3);
        LONG_DEN.add(5, ItemName.VIEN_LINH_HON_CAP_4);
        LONG_DEN.add(5, ItemName.VIEN_LINH_HON_CAP_5);
        LONG_DEN.add(5, ItemName.VIEN_LINH_HON_CAP_6);
        LONG_DEN.add(5, ItemName.VIEN_LINH_HON_CAP_7);
        ...
        LONG_DEN.add(1, ItemName.NHAN_SAM_NGAN_NAM);

        LONG_DEN.add(0.1, ItemName.PHAN_THAN_LENH);
        ...
        LONG_DEN.add(10, ItemName.CHIM_TINH_ANH);
        ...
        LONG_DEN.add(50, ItemName.CHUYEN_TINH_THACH);
